...
const Appointment = () => {
  return (
    ...
    >
     <h1 className='text-[#D9A536] text-4xl'>BEST BARBERSHOP IN THE CITY</h1>
     <div className='max-w-[60%] flex flex-col gap-10'>
     <h1 className='text-7xl text-white text-center'>Making You Look Good Is In Our Heritage</h1>
     <p className='text-3xl text-white text-center'>Barber is a Person Whose Occupation is mainly To Cut Dress Groom Style And Shave Men's And Boy's Hair</p>
     </div>
